...
struct Token lexerGetNextChar(FILE *fd) {
  struct Transition transitionTable[MAX_STATES + 1][MAX_TRANSITIONS + 1] = {
      ...
      {{0, isNonPrinting, NON_ACCEPTING, false, NOT_SYMBOL},
       ...
       {15, isDoubleQuote, NON_ACCEPTING, false, NOT_SYMBOL},
       {19, isSlash, NON_ACCEPTING, false, NOT_SYMBOL},
       {21, isPlus, SIGN, false, PLUS},
       {22, isMinus, SIGN, false, MINUS},
       {23, isStar, SIGN, false, STAR},
       {25, isParenOpen, SIGN, false, OPEN_PAR},
       {26, isParenClose, SIGN, false, CLOSE_PAR},
       {27, isBracketOpen, SIGN, false, OPEN_BRACK},
       {28, isBracketClose, SIGN, false, CLOSE_BRACK},
       {29, isComma, SIGN, false, COMMA},
       {30, isEqual, NON_ACCEPTING, false, NOT_SYMBOL},
       {33, isRef, NON_ACCEPTING, false, NOT_SYMBOL},
       {36, isPipe, NON_ACCEPTING, false, NOT_SYMBOL},
       {38, isSmallerThan, NON_ACCEPTING, false, NOT_SYMBOL},
       {41, isLargerThan, NON_ACCEPTING, false, NOT_SYMBOL},
       {44, isNeg, NON_ACCEPTING, false, NOT_SYMBOL}},
      // State 1
      {{1, isUnderscore, NON_ACCEPTING, false, NOT_SYMBOL},
       {2, isAlpha, NON_ACCEPTING, false, NOT_SYMBOL}},
      // State 2
